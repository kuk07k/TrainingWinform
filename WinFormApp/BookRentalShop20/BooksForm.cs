    ...
    public partial class BooksForm : MetroForm
    {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if(string.IsNullOrEmpty(TxtNames.Text) || string.IsNullOrEmpty(TxtAuthor.Text)
               || string.IsNullOrEmpty(TxtISBN.Text) || string.IsNullOrEmpty(TxtReleaseDate.Text)
        ...
        {
            TxtISBN.Text = TxtNames.Text = TxtIdx.Text = TxtAuthor.Text = "";
            TxtPrice.Text = "";
        ...
        private void SaveProcess()
        {
            ...
            using (SqlConnection conn = new SqlConnection(Commons.CONNSTRING))
            {
                ...
                parmReleaseDate.Value = TxtReleaseDate.Text;
        ...
        private void UpdateCboDivision()
        {
            using (SqlConnection conn = new SqlConnection(Commons.CONNSTRING))
            {
                ...
                SqlDataReader reader = cmd.ExecuteReader(); // 데이터를 sql reader에 가져옴
        ...
        private void TxtReleaseDate_ValueChanged(object sender, EventArgs e)
        {
            TxtReleaseDate.CustomFormat = "yyyy-MM-dd";
            TxtReleaseDate.Format = DateTimePickerFormat.Custom;
        }
